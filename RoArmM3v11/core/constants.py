...
# ============== ZUSÄTZLICHE KONSTANTEN FÜR CORE/__INIT__.PY ==============
# Diese werden von core/__init__.py erwartet

# Joint to Servo Mapping
JOINT_TO_SERVO_MAP = {
    "base": 1,      # Servo ID 1
    "shoulder": 2,  # Servo ID 2  
    "elbow": 3,     # Servo ID 3
    "wrist": 4,     # Servo ID 4
    "roll": 5,      # Servo ID 5
    "hand": 6       # Servo ID 6 (Gripper)
}

# Link Lengths für Kinematik (in Metern)
LINK_LENGTHS = {
    "base_height": 0.06,    # Höhe von Basis zu Shoulder
    "shoulder": 0.105,      # Shoulder zu Elbow
    "elbow": 0.098,        # Elbow zu Wrist  
    "wrist": 0.055,        # Wrist zu Roll
    "hand": 0.070          # Roll zu Gripper-Spitze
}

# Workspace Limits
WORKSPACE = {
    "max_reach": 0.328,    # Maximum reach (sum of link lengths)
    "min_reach": 0.05,     # Minimum reach
    "max_height": 0.40,    # Maximum height
    "min_height": -0.05    # Below base level
}

# ============== EXPORT ALL ==============
# Alle Konstanten die exportiert werden sollen
